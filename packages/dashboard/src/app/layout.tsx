...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" className="dark h-full">
      ...
      <body suppressHydrationWarning className="flex h-full w-full overflow-hidden bg-bg-primary text-text-primary antialiased selection:bg-accent-primary/30 selection:text-white">
        <Sidebar />
