...
/**
 * @file packages/dashboard/src/app/settings/agent/page.tsx
...
export default function AgentSettingsPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const finalHeartbeatContent =
        heartbeatView === 'goals' ? goalsToMarkdown(goals) : heartbeatContent;
        ...
        {activeTab === 'lifecycles' && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-fade-in">
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      onChange={(e) => {
                        setSchedules((prev) => ({
                          ...prev,
                          monitor: { ...prev.monitor, interval: parseInt(e.target.value) },
                        }));
                        setModified(true);
                      }}
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      onChange={(e) => {
                        setSchedules((prev) => ({
                          ...prev,
                          dreamer: { ...prev.dreamer, interval: parseInt(e.target.value) },
                        }));
                        setModified(true);
                      }}
                      className="flex-1 h-2 bg-bg-tertiary rounded-lg appearance-none cursor-pointer accent-accent-primary"
            ...
            <Card className="space-y-4 flex flex-col h-full">
              ...
              <div className="text-sm text-text-muted flex-1">Internal thought processes.</div>
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      onChange={(e) => {
                        setSchedules((prev) => ({
                          ...prev,
                          monologue: { ...prev.monologue, interval: parseInt(e.target.value) },
                        }));
                        setModified(true);
                      }}
                      className="flex-1 h-2 bg-bg-tertiary rounded-lg appearance-none cursor-pointer accent-accent-primary"
                    />
                    <span className="text-xs font-mono w-12 text-right">
                      {schedules.monologue?.interval}m
                    </span>
                  </div>
                </div>
              </div>
            ...
            <Card className="p-4 flex flex-col md:flex-row justify-between items-center gap-6">
              <div className="flex-1">
                ...
                <p className="text-sm text-text-tertiary mt-1">
                  When enabled, the <strong>Dreamer</strong> will propose and automatically apply
                  changes to <code>SOUL.md</code> based on daily experiences.
                </p>
              </div>
              <div className="flex items-center gap-3">
                <span
                  className={
                    soulConfig.autoUpdate
                ...
                >
                  <div
                    className={`w-5 h-5 rounded-full bg-white shadow-sm transition-transform duration-200 ${soulConfig.autoUpdate ? 'translate-x-6' : 'translate-x-0'}`}
                  />
                </button>
              </div>
            </Card>
